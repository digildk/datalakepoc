...
* You must be a Databricks workspace admin in the staging and prod workspaces. 
  ...
  [staging workspace admin console](https://adb-62142598586840.0.azuredatabricks.net#setting/accounts) and
  [prod workspace admin console](https://adb-2075000836620708.8.azuredatabricks.net#setting/accounts). 
