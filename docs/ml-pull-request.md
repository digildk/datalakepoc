...
Links:
* [Staging model in UC](https://adb-62142598586840.0.azuredatabricks.net/explore/data/models/staging/my_mlops_project/my_mlops_project-model)
* [Prod model in UC](https://adb-2075000836620708.8.azuredatabricks.net/explore/data/models/prod/my_mlops_project/my_mlops_project-model)
. 
